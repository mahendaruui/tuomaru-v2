...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>/vendor/matrix_admin/assets/images/favicon.png">
    <title><?= $title; ?></title>
    <!-- Custom CSS -->
    <link href="<?php echo base_url() ?>/vendor/matrix_admin/assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
